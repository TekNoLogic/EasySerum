...
-- Other locales
-- THIS CONTENTS OF THESE OTHER LOCALES ARE AUTO-GENERATED BY THE WOWACE PACKAGER
-- Please use the Localization App on WoWAce to update this
-- at http://www.wowace.com/projects/easyserum/localization/
...
L["Chilled Serpent Mucus"] = "Gekühlter Schlangenschleim"
L["Crates"] = "Kisten"
...
L["Abomination Guts"] = "憎惡體內臟"
L["Amberseed"] = "琥珀種子"
L["Ancient Ectoplasm"] = "上古魂能"
L["Barrels"] = "桶子"
L["Blight Crystal"] = "荒疫水晶"
L["Chilled Serpent Mucus"] = "寒冽巨蛇黏液"
L["Crates"] = "板條箱"
...
L["Chilled Serpent Mucus"] = "Замерзшая змеиная слизь"
L["Crates"] = "ящике"
...
L["Hairy Herring Head"] = "Голову мохнатой селедки"
...
L["Right"] = "Правая"
L["Sacks"] = "мешке"
L["Seasoned Slider Cider"] = "Настоявшееся слабительное"
...
L["Chilled Serpent Mucus"] = "Mucus de serpent glacé"
L["Crates"] = "Caisse"
